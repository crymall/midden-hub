      ...
      <div className="space-y-8">
        <section className="pb-8 mb-6 border-b-2 border-dashed">
          ...
          <ul className="mb-4 text-sm list-inside list-disc space-y-2 pl-2">
            ...
            <li>
              (archaeology) An accumulation, deposit, or soil derived from occupation debris,
              rubbish, or other by-products of human activity, such as bone, shell, ash, or decayed
              organic materials; or a pile or mound of such materials, often prehistoric.
            </li>
          </ul>
        ...
        <section className="space-y-4 leading-relaxed">
          ...
          <p>
            ...
            are little one-off sketches. Midden is the hub, the locus, the pile, the directory, the
            place where it&apos;s all posted for your perusal. For your convenience, I&apos;ve set
            up single sign on for my entire suite of apps—if you register for one, you&apos;ve got
            an account on them all.
          </p>
          <p>
