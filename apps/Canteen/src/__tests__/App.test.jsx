...
vi.mock("../pages/CanteenHome", () => ({
  default: () => <div>CanteenHome Page</div>,
}));
vi.mock("../pages/RecipeSearch", () => ({
  default: () => <div>RecipeSearch Page</div>,
}));
vi.mock("../pages/RecipeDetail", () => ({
  default: () => <div>RecipeDetail Page</div>,
}));
vi.mock("../pages/EditRecipe", () => ({
  default: () => <div>EditRecipe Page</div>,
}));
vi.mock("../pages/NewRecipe", () => ({
  default: () => <div>NewRecipe Page</div>,
}));
vi.mock("../pages/MyLists", () => ({ default: () => <div>MyLists Page</div> }));
vi.mock("../pages/ListView", () => ({
  default: () => <div>ListView Page</div>,
}));
...
vi.mock("../pages/Conversation", () => ({
  default: () => <div>Conversation Page</div>,
}));
vi.mock("../pages/FollowerFollowingLists", () => ({
  default: () => <div>FollowerFollowingLists Page</div>,
}));

vi.mock("@shared/core/components/Header", () => ({
